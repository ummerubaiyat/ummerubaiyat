...
<p><em>PhD student in Intelligence & Control | MEXT Scholar | at <a href="http://www.unb.br">Gunma University, Japan 🇯🇵</a><img src="https://media.giphy.com/media/fYSnHlufseco8Fh93Z/giphy.gif" width="30">
...
@dataclass
class Introduction:
    work: list[str] = ["Autonomous Vehicle","DataScience", "MachineLeaning","DeepLearning", "ComputerVision" ]
    interest: list[str] = ["Astronomy","Books","Literature","ArtWork"]
